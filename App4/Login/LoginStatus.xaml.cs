using System;
using App4.Shared.Helpers;
using App4.Shared.Models;
using App4.Shared.Services;
    ...
    public sealed partial class LoginStatus : UserControl
    {
        ...
        private void UpdateLoginState()
        {
            ...
            else
            {
                ...
                welcomeText=new TextBlock();  // added for windows only   
                welcomeText.Text = "logging out";// original -> string.Empty;
            }
        }
    }
}
